...
export class SmrtgraphSettingsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.compoundLabelCtrl.valueChanges.subscribe(value => {this.settingsService.settings.compoundLabel = value; this.settingsService.dataChange.next(this.settingsService.settings)});
    ...
    this.showLinkLabelCtrl.valueChanges.subscribe(value => {this.settingsService.settings.showLinkLabel = value; this.settingsService.dataChange.next(this.settingsService.settings)});
  }
